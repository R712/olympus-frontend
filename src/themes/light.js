...
const lightTheme = {
  ...
  color: "#000025",
  gold: "#268DFF",
  gray: "rgba(0, 2, 37, 0.4)",
  blueish_gray: "rgba(0, 2, 37, 0.6)",
  textHighlightColor: "#268DFF",
  ...
  primaryButtonHoverBG: "#000025",
  // these need fixing
  primaryButtonHoverColor: "#FFF",
  containedSecondaryButtonHoverBG: "#F6FBFF",
  SecondaryButtonHoverColor: "#000025",
  outlinedPrimaryButtonHoverBG: "#F8CC82",
  outlinedPrimaryButtonHoverColor: "#333333",
  outlinedSecondaryButtonHoverBG: "#F6FBFF",
      ...
      overrides: {
        ...
        MuiButton: {
          ...
          containedSecondary: {
            ...
            backgroundColor: lightTheme.paperBg,
            "&:hover": {
              color: lightTheme.SecondaryButtonHoverColor,
